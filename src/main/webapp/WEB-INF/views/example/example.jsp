...
<form method="POST" action="${pageContext.request.contextPath}/NoticeBoardWrite">
      <div class="enroll enroll-1 active">
         <section class="transportContent" id = "transportContent">
            <div class="title">
               <span>타이틀</span> 
               <input type="text" id="noticeTitle" name="noticeTitle" class="req" placeholder="제목을 간략히 적어주세요." required>
               <span>전송 내용</span>
               <input type="text" name="noticeContent" style="height:250px" class="req" placeholder="내용을 간략하게 적어주세요." required>
               <span>수신처</span>
               <select id="noticeDestination" name="noticeDestination" class="req" required>
                         <option value="" selected> 수신처 목록 </option>  
