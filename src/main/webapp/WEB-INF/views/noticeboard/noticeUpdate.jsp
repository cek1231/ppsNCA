...
<form method="POST" action="${pageContext.request.contextPath}/NoticeBoardUpdate">
      <div class="enroll enroll-1 active">
         <section class="transportContent" id = "transportContent">
            <div class="title">
               <span>타이틀</span> 
               <input type="text" id="noticeTitle" name="noticeTitle" class="req" value="${ board.boardTitle }" required>
               <span>전송 내용</span>
               <input type="text" name="noticeContent" style="height:250px" class="req" value="${ board.boardContents }" placeholder="내용을 간략하게 적어주세요." required>
               <span>수신처</span>
               <select id="noticeDestination" name="noticeDestination" class="req" disabled>
                         <option value="" selected>${ board.boardDestination }</option>  
               ...
               <div class="btn">
                  ...
                  <!-- <button>이전으로</button> -->
                  <input type="submit" class="next" value="데이터 수정" />
